...
/// <summary>
/// Client for <c>api/xray-client-links</c> (same DTO shape as OpenVPN files; body is share-link text).
/// Android parity: <c>XrayClientLinksApiClient</c>.
/// </summary>
public sealed class XrayClientLinksApiClient(HttpClient http)
{
        ...
        CancellationToken ct)
    {
        var req = new HttpRequestMessage(
            HttpMethod.Post,
            "api/xray-client-links/download-file-by-cn")
        {
